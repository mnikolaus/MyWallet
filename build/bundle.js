...
var _reactInputAutosize = __webpack_require__(355);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(93), __webpack_require__(333)(module)))
...
var aa = __webpack_require__(29),
    l = __webpack_require__(340),
    B = __webpack_require__(128),
    C = __webpack_require__(65),
    ba = __webpack_require__(341),
    da = __webpack_require__(342),
    ea = __webpack_require__(343),
    fa = __webpack_require__(344),
    ia = __webpack_require__(347),
...
var calculateStuff = function calculateStuff(list, rates, defaultCurrency, invested) {
  var sum = 0;
  var newList = list.map(function (item) {
    var newAmount = Number(parseFloat(item.amount) * rates[item.currency][defaultCurrency]).toFixed(2); // eslint-disable-line max-len
...
var App = function (_Component) {
  ...
  function App() {
    ...
    _this.handleUserListChange = _this.handleUserListChange.bind(_this);
    _this.getExchangeRates = _this.getExchangeRates.bind(_this);
    return _this;
  }
  ...
  _createClass(App, [{
    ...
    value: function componentDidMount() {
      ...
      if (!this.state.currencyList) {
        _actions2.default.getCryptoList().then(function (result) {
          _this2.setState({ currencyList: result, loading: '' });
        }).then(function () {});
    ...
    value: function getExchangeRates(cryptoCurrencies, realCurrency) {
      var _this3 = this;

      var currencies = cryptoCurrencies.map(function (cur) {
        return cur.currency;
      });
      var endpointUrl = 'https://min-api.cryptocompare.com/data/pricemulti?fsyms=' + currencies.join(',') + '&tsyms=' + realCurrency;
    ...
    key: 'handleUserListChange',
    value: function handleUserListChange(newList) {
      this.setState({
        loading: 'calculating',
        popup: false,
        userList: newList
    ...
    value: function render() {
      ...
      var _state = this.state,
          ...
          currencyList = _state.currencyList,
          exchangeRates = _state.exchangeRates,
      ...
      if (loading) {
        return _react2.default.createElement(_Loader2.default, { text: loading });
      }
      return _react2.default.createElement(
          ...
          _react2.default.createElement(
            'button',
            {
              ...
              onClick: function onClick() {
                return _this4.setState({ popup: true });
              }
            },
            'Edit list'
          ),
          userList && exchangeRates && _react2.default.createElement(_Table2.default, {
            data: calculateStuff(userList, exchangeRates, currency, invested)
          }),
        ...
        popup && _react2.default.createElement(_Popup2.default, {
          currencyList: currencyList,
          userList: userList,
          onCancel: function onCancel() {
            return _this4.setState({ popup: false });
          },
...
var _reactSelect = __webpack_require__(131);

var _reactSelect2 = _interopRequireDefault(_reactSelect);

__webpack_require__(357);

var _currencies = __webpack_require__(358);
...
var Header = function Header(_ref) {
  var changeCurrency = _ref.changeCurrency,
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        'div',
        { className: 'right', style: { width: '100px' } },
        _react2.default.createElement(_reactSelect2.default, {
          clearable: false,
          onChange: function onChange(val) {
            return changeCurrency(val.value);
          },
          options: _currencies2.default,
          searchable: false,
          value: currency
        })
      )
...
Header.propTypes = {
  changeCurrency: _propTypes2.default.func.isRequired,
...
var _numeral = __webpack_require__(361);
          ...
          data.list.map(function (line) {
            return _react2.default.createElement(
              ...
              _react2.default.createElement(
                'td',
                null,
                (0, _numeral2.default)(line.changedAmount).format('0.00 a'),
                ' ',
                _react2.default.createElement(
                  'span',
                  { className: 'currency' },
                  line.changedCurrency
                )
              )
            );
          })
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'td',
              null,
              (0, _numeral2.default)(data.invested.toFixed(2)).format('0.00 a'),
              ' ',
              _react2.default.createElement(
                'span',
                { className: 'currency' },
            ...
            _react2.default.createElement(
              'td',
              null,
              (0, _numeral2.default)(data.sum.toFixed(2)).format('0.00 a'),
              ' ',
              _react2.default.createElement(
                'span',
                { className: 'currency' },
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              (0, _numeral2.default)(data.sum.toFixed(2) - data.invested.toFixed(2)).format('0.00 a'),
              ' ',
              _react2.default.createElement(
                'span',
                { className: 'currency' },
...
Table.propTypes = {
  data: _propTypes2.default.shape({
    sum: _propTypes2.default.number,
    list: _propTypes2.default.array,
    defaultCurrency: _propTypes2.default.string
  }).isRequired
};
...
var Popup = function (_Component) {
  ...
  function Popup(props) {
    ...
    _this.generateUserList = _this.generateUserList.bind(_this);
  ...
  _createClass(Popup, [{
    ...
    value: function addToList() {
      var newList = this.state.userList.slice(0);
      newList.push({
    ...
    value: function removeFromList(index) {
      this.setState({
        userList: this.state.userList.filter(function (a, i) {
          return i !== index;
        })
      });
    }
    ...
    value: function generateUserList(list) {
      var _this2 = this;

      return list.map(function (item, i) {
        return _react2.default.createElement(
          'tr',
          { key: item.currencyList + '-' + item.amount },
          _react2.default.createElement(
            'td',
            null,
            _react2.default.createElement(
              'button',
              {
                className: 'delete',
                onClick: function onClick() {
                  return _this2.removeFromList(i);
                }
              },
              '-'
            ),
            _react2.default.createElement('input', { type: 'number', value: item.amount })
          ),
          _react2.default.createElement(
            'td',
            null,
                ...
                _react2.default.createElement(
                  ...
                  _react2.default.createElement(
                    ...
                    _react2.default.createElement('input', {
                      onChange: function onChange(e) {
                        return _this3.setState({ newAmount: e.target.value });
                      },
                      type: 'number',
                  ...
                  _react2.default.createElement(
                    ...
                    _react2.default.createElement(_reactSelect2.default, {
                      ...
                      onChange: function onChange(val) {
                        return _this3.setState({ newCurrency: val.value });
                      },
...
Popup.propTypes = {
  currencyList: _propTypes2.default.array.isRequired, // eslint-disable-line react/forbid-prop-types
  onCancel: _propTypes2.default.func.isRequired,
  onSave: _propTypes2.default.func.isRequired,
  userList: _propTypes2.default.array // eslint-disable-line react/forbid-prop-types
};
...
var storedList = 'currencyList';

var getListFromStorage = function getListFromStorage(object, cb) {
  cb(JSON.parse(localStorage.getItem(object)));
};

var setLocalStorageItem = function setLocalStorageItem(item, value) {
...
var getCryptoList = function getCryptoList() {
...
exports.default = {
  ...
  getListFromStorage: getListFromStorage
};
